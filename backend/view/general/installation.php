...
<div class="MContent800">
	...
	<section>
		...
		<p>MogulMVC has very few requirements and will work on most shared hosted environments.</p>

		<div class="indent">
		
			<h3>Web Server</h3>
			<p>Any web server that supports PHP. MogulMVC has been tested on Apache, NGINX and HipHop for PHP. Apache is prefered.<br />
				MogulMVC also requires a way to rewrite the path. In Apache this is provided by mod_rewrite.
			</p>
	
			<h3>PHP Version</h3>
			<p>MogulMVC requires PHP 5.3.</p>
	...
	<section>
		...
		<p>To install and start using MogulMVC you need to first get the source code. To download the source code click the "Download" button on the home page.</p>
	
		<p>After you get the source code you will notice there are 2 directories in the root directory as well as an .bowerrc, .htaccess, bower.json, and composer.json file. The two directories are backend and frontend. We will discuss the .htaccess file is configured to make Apache work with MogulMVC's organizational system. The .bowerrc and bower.json files are for frontend <a href="http://bower.io/">Bower</a> package managment. The composer.json file is for backend <a href="http://getcomposer.org/">Composer</a> package managment.</p>
